...
get_ipython().run_cell_magic("wstl", " --output resources --input file://./mapping_configs/omop_fhir_r4/ConditionOccurence.fhir.input.json --library_config file://./mapping_configs/omop_fhir_r4/projector_library/*.wstl --code_config file://./mapping_configs/omop_fhir_r4/code_harmoninzation/*.json", """

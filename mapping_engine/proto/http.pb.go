...
type ServerDefinition_CustomGcp struct {
	CustomGcp *CustomGCPConfig `protobuf:"bytes,2,opt,name=custom_gcp,json=customGcp,proto3,oneof"` // TODO (b/122273125): Support additional server types.
}

func (*ServerDefinition_CustomGcp) isServerDefinition_AuthenticationConfig() {}

// TODO(b/130808132): Remove since its not needed anymore.
...
type CloudFunction struct {
	...
	// TODO(b/130820563): Evaluate the @ convention.
